...
class Rota
{
    ...
    public function iniciarRotas()
    {
        ...
        $this->rotas['/adminstrador/cadastrar-administrador'] = array('classe' => 'Administrador', 'metodo' =>"AdicionarAdminstrador",'parametro' => array('administrador','administrador.html')); 
